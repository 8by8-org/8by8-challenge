        ...
        <ol>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                Registration Paperwork: To enable you to access your completed
                voter registration forms via the app, we store a URL linking to
                this paperwork generated by Rock the Vote.
              </li>
              <li>
                Cookies and Tracking Technologies: We use cookies and similar
                technologies to maintain user sessions and provide a secure
                login experience, improve user experience, and remember your
                preferences. Cookies are small text files that are stored on
                your device and may be used for session management, analytics,
                and personalization.
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                To allow you to access your voter registration paperwork from
                the application.
              </li>
              <li>
